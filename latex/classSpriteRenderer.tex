...
\begin{DoxyCompactList}\small\item\em render\+Game\+Object Overloaded function from \mbox{\hyperlink{classRenderer}{Renderer}}. Converts the data into the appropriate Sprite. This function adds animations or changes colors depending on the data. It does not actually re-\/render the sprites every time data is changed. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em render\+Game\+Object Overloaded from \mbox{\hyperlink{classRenderer}{Renderer}}. Makes a new \mbox{\hyperlink{classGamePixmapItem}{Game\+Pixmap\+Item}} and adds the appropriate sprite. This function is only run once in the \mbox{\hyperlink{classSpriteRenderer}{Sprite\+Renderer}}. Which means that changes to the objects are applied to the same sprite. The other renderers do not have this feature since the bulk of the changes are very difficult to animate using parameters and not generalizable. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
\begin{DoxyCompactList}\small\item\em Cached images for tiles and characters. \end{DoxyCompactList}\item 
QImage \mbox{\hyperlink{classSpriteRenderer_afe7be8b7fb831574f3c2d78ac3a33f13}{m\+\_\+characters}}
\begin{DoxyCompactList}\small\item\em Cached images for tiles and characters. \end{DoxyCompactList}\end{DoxyCompactItemize}

\textbf{ }\par
\begin{DoxyCompactItemize}
\item 
QSize \mbox{\hyperlink{classSpriteRenderer_a54100f341345a0cb646e8bdfb38382dd}{m\+\_\+char\+Size}}
\begin{DoxyCompactList}\small\item\em Cached Cached sizes for the images. \end{DoxyCompactList}\item 
QSize \mbox{\hyperlink{classSpriteRenderer_aedb48410d0443aee1efec9eab1be401d}{m\+\_\+tile\+Size}}
\begin{DoxyCompactList}\small\item\em Cached Cached sizes for the images. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{32                         \{}
\DoxyCodeLine{33         \mbox{\hyperlink{classSpriteRenderer_aba39a325f77669c8e0494bfd97f91171a7b3e4dbb386842de9803d178bc68408a}{TILE\_COUNT}} = 21,}
\DoxyCodeLine{34         \mbox{\hyperlink{classSpriteRenderer_aba39a325f77669c8e0494bfd97f91171a7aa3a010569edc6d5e7f9996bb51ff4a}{CHAR\_MAX\_X}} = 10,}
\DoxyCodeLine{35         \mbox{\hyperlink{classSpriteRenderer_aba39a325f77669c8e0494bfd97f91171aa151fb96926dd5c99c666aeb0acb2e29}{CHAR\_MAX\_Y}} = 8,}
\DoxyCodeLine{36     \};}
...
render\+Game\+Object Overloaded from \mbox{\hyperlink{classRenderer}{Renderer}}. Makes a new \mbox{\hyperlink{classGamePixmapItem}{Game\+Pixmap\+Item}} and adds the appropriate sprite. This function is only run once in the \mbox{\hyperlink{classSpriteRenderer}{Sprite\+Renderer}}. Which means that changes to the objects are applied to the same sprite. The other renderers do not have this feature since the bulk of the changes are very difficult to animate using parameters and not generalizable. 
...
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
A \mbox{\hyperlink{classGamePixmapItem}{Game\+Pixmap\+Item}} containing a sprite sheets for the correct \mbox{\hyperlink{classGameObject}{Game\+Object}}. 
\end{DoxyReturn}
...
render\+Game\+Object Overloaded function from \mbox{\hyperlink{classRenderer}{Renderer}}. Converts the data into the appropriate Sprite. This function adds animations or changes colors depending on the data. It does not actually re-\/render the sprites every time data is changed. 


\begin{DoxyParams}{Parameters}
{\em data} & The \mbox{\hyperlink{classGameObject}{Game\+Object}} data The \mbox{\hyperlink{classGameObject}{Game\+Object}} data. \\
\hline
{\em item} & The \mbox{\hyperlink{classGamePixmapItem}{Game\+Pixmap\+Item}} to write the data on. \\
\hline
\end{DoxyParams}
...
Cached Cached sizes for the images. 
